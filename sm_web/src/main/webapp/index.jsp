...
<frameset rows="85,*" cols="*" frameborder="no" border="0" framespacing="0">
    ...
    <frameset cols="250,*" name="btFrame" frameborder="NO" border="0" framespacing="0">
        <frame src="${pageContext.request.contextPath}/left.jsp" noresize name="menu" scrolling="yes">
        <frame src="${pageContext.request.contextPath}/staff/list.do" class="frame_r" noresize name="main" scrolling="yes">
    </frameset>
</frameset>
<noframes>
